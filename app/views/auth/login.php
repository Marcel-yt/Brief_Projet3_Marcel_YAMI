...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        if ($user['status'] !== 'active') {
            ...
            $_SESSION['username'] = $user['username']; // Ajout du nom d'utilisateur
...
<main class="container mx-auto p-4">
    ...
    <form action="login.php" method="POST" class="bg-white p-6 rounded shadow-md max-w-md mx-auto">
        <div class="mb-4">
        ...
        <button type="submit" 
                class="w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded transition duration-150 ease-in-out">
            Se connecter
        </button>
    </form>
</main>
